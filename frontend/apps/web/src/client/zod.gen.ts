...
export const zAddressUpdate = z.object({
  ...
  street2: z.optional(z.union([z.string(), z.null()])),
  barangay: z.optional(z.union([z.string(), z.null()])),
  city: z.optional(z.union([z.string().max(50), z.null()])),
  region: z.optional(z.union([z.string().max(50), z.null()])),
  postal_code: z.optional(z.union([z.string().max(20), z.null()])),
  is_primary: z.optional(z.union([z.boolean(), z.null()])),
});
 ...
 */
export const zBodyUploadProductImageApiV1FarmerProductProductIdImagesPost =
  z.object({
    file: z.string(),
  });
 ...
 * Role
 */
export const zRole = z.enum(["farmer", "customer"]);
...
export const zPrismaModelsAddress = z.object({
  ...
  is_primary: z.boolean(),
  user: z.optional(z.union([zPrismaModelsUser, z.null()])),
});

/**
 * ProductStatus
 */
export const zProductStatus = z.enum(["draft", "active", "archived", "sold"]);

/**
 * ProductVisibility
 */
export const zProductVisibility = z.enum(["public", "private"]);
...
export const zProductCategory = z.object({
  id: z.int(),
  name: z.string(),
  products: z.optional(z.union([z.array(zPrismaModelsProduct), z.null()])),
});
...
export const zProductImage = z.object({
  ...
  product: z.optional(z.union([zPrismaModelsProduct, z.null()])),
});
...
export const zReview = z.object({
  ...
  customer: z.optional(z.union([zPrismaModelsUser, z.null()])),
  product: z.optional(z.union([zPrismaModelsProduct, z.null()])),
});
...
export const zPrismaModelsCart = z.object({
  ...
  is_active: z.boolean(),
  customer: z.optional(z.union([zPrismaModelsUser, z.null()])),
  cart_items: z.optional(z.union([z.array(zPrismaModelsCartItem), z.null()])),
});
...
export const zPrismaModelsCartItem = z.object({
  ...
  cart: z.optional(z.union([zPrismaModelsCart, z.null()])),
  product: z.optional(z.union([zPrismaModelsProduct, z.null()])),
});
...
export const zFarmerOrder = z.object({
  ...
  subtotal: z.string(),
  created_at: z.iso.datetime(),
  order: z.optional(z.union([zCustomerOrder, z.null()])),
  farmer: z.optional(z.union([zPrismaModelsUser, z.null()])),
  order_item: z.optional(z.union([z.array(zOrderItem), z.null()])),
});
...
export const zOrderItem = z.object({
  ...
  order: z.optional(z.union([zCustomerOrder, z.null()])),
  product: z.optional(z.union([zPrismaModelsProduct, z.null()])),
  order_farm: z.optional(z.union([zFarmerOrder, z.null()])),
});
...
export const zPrismaModelsProduct = z.object({
  ...
  created_at: z.iso.datetime(),
  user: z.optional(z.union([zPrismaModelsUser, z.null()])),
  category: z.optional(z.union([zProductCategory, z.null()])),
  images: z.optional(z.union([z.array(zProductImage), z.null()])),
  reviews: z.optional(z.union([z.array(zReview), z.null()])),
  cart_items: z.optional(z.union([z.array(zPrismaModelsCartItem), z.null()])),
  order_item: z.optional(z.union([z.array(zOrderItem), z.null()])),
});
...
export const zPrismaModelsUser = z.object({
  ...
  created_at: z.iso.datetime(),
  addresses: z.optional(z.union([z.array(zPrismaModelsAddress), z.null()])),
  products: z.optional(z.union([z.array(zPrismaModelsProduct), z.null()])),
  reviews: z.optional(z.union([z.array(zReview), z.null()])),
  cart: z.optional(z.union([z.array(zPrismaModelsCart), z.null()])),
  Order: z.optional(z.union([z.array(zCustomerOrder), z.null()])),
  OrderFarm: z.optional(z.union([z.array(zFarmerOrder), z.null()])),
});
...
export const zCustomerOrder = z.object({
  ...
  created_at: z.iso.datetime(),
  customer: z.optional(z.union([zPrismaModelsUser, z.null()])),
  farmer_order: z.optional(z.union([z.array(zFarmerOrder), z.null()])),
  order_item: z.optional(z.union([z.array(zOrderItem), z.null()])),
});
...
export const zNotificationPayload = z.object({
  user_id: z.string(),
  actor_id: z.optional(z.union([z.string(), z.null()])),
  actor_name: z.optional(z.union([z.string(), z.null()])),
  title: z.string(),
  message: z.string(),
  type: zNotificationType,
  data: z.optional(z.union([z.record(z.string(), z.unknown()), z.null()])),
});
...
export const zProductUpdate = z.object({
  ...
  category_id: z.optional(z.union([z.int(), z.null()])),
  unit: z.optional(z.union([z.string().max(20), z.null()])),
  price_per_unit: z.optional(z.union([z.number(), z.null()])),
  stock_quantity: z.optional(z.union([z.int(), z.null()])),
  status: z.optional(z.union([zProductStatus, z.null()])),
  visibility: z.optional(z.union([zVisibility, z.null()])),
});
...
export const zUserUpdate = z.object({
  ...
  suffix: z.optional(z.union([z.string(), z.null()])),
  profile_image_url: z.optional(z.union([z.url().min(1).max(2083), z.null()])),
...
export const zSrcModelsCartCartItem = z.object({
  ...
  quantity: z.int(),
  product_id: z.string(),
  product: z.optional(z.union([z.unknown(), z.null()])),
  id: z.string(),
  added_at: z.iso.datetime(),
});
...
export const zSrcModelsCartCart = z.object({
  ...
  created_at: z.iso.datetime(),
  updated_at: z.iso.datetime(),
  customer: z.optional(z.union([zSrcModelsUserUser, z.null()])),
...
export const zMyProductsApiV1FarmerProductsGetData = z.object({
  ...
  query: z.optional(
    z.object({
      ...
      visibility: z.optional(z.union([z.string(), z.null()])),
 ...
 * Successful Response
 */
export const zViewProductApiV1FarmerProductProductIdGetResponse =
  zSrcModelsProductProduct;
 ...
 * Successful Response
 */
export const zUpdateProductApiV1FarmerProductProductIdPatchResponse =
  zSrcModelsProductProduct;
 ...
 * Successful Response
 */
export const zCreateProductApiV1FarmerProductPostResponse =
  zSrcModelsProductProduct;

export const zUploadProductImageApiV1FarmerProductProductIdImagesPostData =
  z.object({
 ...
 * Successful Response
 */
export const zUploadProductImageApiV1FarmerProductProductIdImagesPostResponse =
  zSrcModelsProductProduct;

export const zDeleteProductImageApiV1FarmerProductProductIdImagesImageIdDeleteData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      product_id: z.string(),
...
export const zUpdateProductStatusApiV1FarmerOrdersOrderIdStatusPatchData =
  z.object({
...
export const zUpdateCartItemQuantityApiV1CustomerCartItemsItemIdQuantityPatchData =
  z.object({
...
export const zDeleteCartItemApiV1CustomerCartItemsItemIdDeleteDeleteData =
  z.object({
    body: z.optional(z.never()),
    path: z.object({
      item_id: z.uuid(),
 ...
 * Successful Response
 */
export const zCreateAddressApiV1UsersMeAddressPostResponse =
  zSrcModelsAddressAddress;
 ...
 * Successful Response
 */
export const zUpdateAddressApiV1UsersMeAddressAddressIdPatchResponse =
  zSrcModelsAddressAddress;
